...
const SingleDanceMat = () => {
  const singleDanceToy = useLoaderData();
    const { SubCategory, description, name, photoURL, price, quantity, rating, sellerEmail, sellerName, } = singleDanceToy;
    UseTitle('Dance Mat')
